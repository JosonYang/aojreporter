...
namespace AojReport.AojPrintEngine.Common
{
    ...
    public class AojFilesHelper
    {
        ...
        /// <param name="strPath">目录路径</param>
        /// <returns></returns>
        public static bool IsDicretory(string strPath)
        {
        ...
        {
            // 目标目录不存在,创建目录
            if (IsDicretory(target.FullName) == false)
            {
        ...
        /// <returns></returns>
        public static bool IsFile(string strPath)
        {
